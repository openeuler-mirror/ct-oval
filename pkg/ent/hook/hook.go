...
// The CverefFunc type is an adapter to allow the use of ordinary
// function as Cveref mutator.
type CverefFunc func(context.Context, *ent.CverefMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CverefFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CverefMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CverefMutation", m)
}
...
// The OvalFunc type is an adapter to allow the use of ordinary
// function as Oval mutator.
type OvalFunc func(context.Context, *ent.OvalMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OvalFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.OvalMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OvalMutation", m)
}
